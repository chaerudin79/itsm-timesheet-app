      ...
      >
        <div className="p-6 lg:p-8 max-w-4xl space-y-7">
          ...
          >
            ...
            <motion.div className="rounded-[10px] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-5" variants={itemVariants}>
            ...
            <motion.div className="rounded-lg border border-white/[0.07] bg-[#111113] p-5" variants={itemVariants}>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-md text-sm font-semibold bg-[var(--brand-orange)] text-white hover:bg-[var(--brand-orange-hover)] transition-colors"
                >
                  Manage Rules
                </button>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full px-3 py-2 pr-14 bg-[#0A0A0B] border border-white/10 rounded-md text-white text-sm placeholder-slate-500 focus:outline-none focus:border-[#06B6D4]/60 resize-vertical"
                  />
                  <button
                ...
                <p className="text-xs text-slate-500">
                  Get your API key from <a href="https://console.groq.com" target="_blank" rel="noreferrer" className="text-[var(--accent)] hover:underline">console.groq.com</a>
                </p>
                {groqApiKeys && (
