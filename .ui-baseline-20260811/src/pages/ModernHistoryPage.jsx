    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          animate="visible"
        >
          <h1 className="text-[26px] font-semibold text-white tracking-tight mb-1.5">Ticket History</h1>
        ...
        >
          ...
          <motion.div className="rounded-lg border border-white/[0.07] bg-[#111113] p-5" variants={itemVariants}>
            ...
            <p className="text-[26px] font-semibold text-[#06B6D4] tabular-nums">{filtered.length}</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/[0.07] bg-[#111113] p-5" variants={itemVariants}>
        ...
        >
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-md text-sm font-medium bg-[#06B6D4] text-black hover:bg-[#06B6D4]/85 ml-auto flex items-center gap-2 transition-colors"
            >
